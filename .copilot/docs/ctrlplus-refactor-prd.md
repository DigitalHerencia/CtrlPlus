...
- Primary: Copilot and other agents operating in this repo
...
- Agents can identify current state, target state, dependencies, and open decisions from `.copilot/**` alone.

## 7. Acceptance Criteria

- A repo-local `.copilot` scaffold exists with markdown, YAML, and JSON layers.
