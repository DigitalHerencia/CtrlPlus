...
- `.copilot/` previously contained only profile artifacts and no program-level guidance.
...
- `.copilot` markdown docs for intent and architecture
- `.copilot` YAML contracts for boundaries and workstreams
- `.copilot` JSON execution files for backlog and progress
