...
1. Read `.copilot/README.md`.
2. Read the relevant docs in `.copilot/docs/`.
3. Read the relevant contracts in `.copilot/contracts/`.
4. Read the current state in `.copilot/execution/`.
5. Use the relevant prompt in `.copilot/prompts/` only after the prior layers are understood.
