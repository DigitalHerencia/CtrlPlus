...
// Runtime JS: enforce that `.copilot/instructions/*.instructions.md` files are
// scoped with an `applyTo` frontmatter so they are not auto-applied globally.
