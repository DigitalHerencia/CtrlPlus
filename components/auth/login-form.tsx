      ...
      if (awaitingSecondFactor) {
        ...
        const verifyResult =
          secondFactorMethod === "phone_code"
            ? await signIn.mfa.verifyPhoneCode({ code: parsedVerification.data.verificationCode })
            : await signIn.mfa.verifyEmailCode({ code: parsedVerification.data.verificationCode });
      ...
      <FieldGroup className="gap-6 border border-neutral-800 bg-neutral-950/90 p-6 shadow-[0_24px_80px_-48px_rgba(0,0,0,0.9)] sm:p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 max-w-sm text-sm text-neutral-400">
            Sign in to manage your storefront, bookings, and customer workflows.
          </p>
        </div>
