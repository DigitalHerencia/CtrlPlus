    ...
    return (
        <Card className="border-neutral-700 bg-neutral-950/80 text-neutral-100">
            <CardHeader>
                ...
                <CardDescription>
                    Clear stuck processing rows and reset failed lock records to enable controlled
                    replay.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                <div className="grid gap-4 lg:grid-cols-3">
                    ...
                    >
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-neutral-400">
                                Marks stale processing records as failed so they can be retried
                                safely.
                            </p>
                        </div>
                        ...
                        <Button
                            type="submit"
                            disabled={clearForm.formState.isSubmitting}
                            className="w-full"
                        >
                            {clearForm.formState.isSubmitting
                                ? 'Clearing...'
                    ...
                    <form
                        onSubmit={clerkResetForm.handleSubmit((values) =>
                            handleReset(values, 'clerk')
                        )}
                        className="space-y-3 border border-neutral-800 bg-neutral-900/70 p-4"
                    >
                        <div className="space-y-1">
                            <h3 className="text-sm font-semibold text-neutral-100">
                                Reset Clerk Failures
                            </h3>
                            <p className="text-sm text-neutral-400">
                        ...
                        <Button
                            ...
                            variant="outline"
                            disabled={
                                clerkResetForm.formState.isSubmitting ||
                                clerkFailureIds.length === 0
                            }
                            className="w-full"
                        >
                            {clerkResetForm.formState.isSubmitting
                    ...
                    <form
                        onSubmit={stripeResetForm.handleSubmit((values) =>
                            handleReset(values, 'stripe')
                        )}
                        className="space-y-3 border border-neutral-800 bg-neutral-900/70 p-4"
                    >
                        <div className="space-y-1">
                            <h3 className="text-sm font-semibold text-neutral-100">
                                Reset Stripe Failures
                            </h3>
                            <p className="text-sm text-neutral-400">
