  ...
  return (
    <div className="w-full max-w-sm border border-neutral-700 bg-neutral-900 p-3">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                todayCell && !selected ? "border border-blue-600 font-medium text-neutral-100" : "",
      ...
      {availableWeekdays.length === 0 && (
        <p className="mt-4 text-center text-sm text-neutral-100">No availability configured.</p>
      )}
    </div>
  );
}
