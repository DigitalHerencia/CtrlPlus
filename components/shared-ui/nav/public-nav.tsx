...
export function PublicNav({ activePath, hidePrimaryNav = false }: PublicNavProps) {
  return (
    <header className='sticky top-0 z-50 border-b border-[color:var(--border)] bg-[color:var(--surface-card)]/95 backdrop-blur'>
      <div className='mx-auto flex w-full max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-4 md:px-6'>
        <Link className='text-lg font-semibold tracking-[0.03em] text-[color:var(--text)]' href='/'>
          CTRL+
        </Link>
