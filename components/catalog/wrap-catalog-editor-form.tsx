...
import { wrapCatalogEditorFormSchema } from '../../schemas/catalog';
    ...
    >
      <label className="grid gap-2">
        ...
        {form.formState.errors.name ? (
          <span className="text-xs text-red-500">
            {toErrorMessage(form.formState.errors.name.message)}
          </span>
        ) : null}
      </label>
      ...
      <label className="grid gap-2">
        ...
        {form.formState.errors.priceCents ? (
          <span className="text-xs text-red-500">
            {toErrorMessage(form.formState.errors.priceCents.message)}
          </span>
        ) : null}
      </label>
      ...
      {includePublishState ? (
        <label className="grid gap-2">
          ...
          <NativeSelect {...form.register('isPublished')}>
