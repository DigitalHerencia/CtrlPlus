...
- Generic `.copilot` prompts and execution state were behind the live catalog implementation before this prep pass.
...
- `.copilot/arch/copilot_catalog_visualizer_migration_spec.md`
- `.copilot/instructions/catalog.instructions.md`
- `.copilot/contracts/catalog-visualizer.contract.yaml`
- `.copilot/prompts/catalog.refactor.prompt.md`
